---
title: A demo of `react-markdown` English and for something until sixty characters
...
tags: [react, performance, web, lighthouse, testing, markdown, mdx, development]
---

<CloudinaryImg src="/blog/dummy-article/retrosupply-jLwVAUtLOAQ-unsplash.jpg" caption="Photo by RetroSupply" />
...
Here is an example of a plugin in action ([`remark-toc`](https://github.com/remarkjs/remark-toc)). **This section is
...
For GFM, you can _also_ use a plugin: [`remark-gfm`](https://github.com/remarkjs/react-markdown#use). It adds support
for GitHub-specific extensions to the language: tables, strikethrough, tasklists, and literal URLs.
...
[`rehype-raw`](https://github.com/rehypejs/rehype-raw). You should probably combine it with
...
<CloudinaryImg src="/blog/dummy-article/patrick-tomasso-Oaqk7qqNh_c-unsplash.jpg" caption="Photo by Patrick Tomasso" />
...
<CloudinaryImg src="/blog/dummy-article/scott-graham-5fNmWej4tAA-unsplash.jpg" caption="Photo by Scott Graham" />

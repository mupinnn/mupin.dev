...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/cca131cf-ef22-4432-a0f2-1188aa3e73b6/image.png)
...
3. After the remote repository is created, two guides will appear to push our local repository to the remote repository
   ...
   ![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/6a0d1b9e-974d-4b8b-aaa6-b4e129989128/image.png)

4. Reload the page and make sure your remote repository looks something like this:

   ![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/cc753144-befb-4cfc-89a6-33a80a3e3022/image.png)
...
6. Then, in the “Permissions” section, select Account, Cloudflare Pages, and Edit (select the options in order from left
   to right)
7. Click “Continue to summary”, then click “Create token”
8. Copy and save the token for later use in Github Actions and APIs

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/81e7a577-346d-40f9-bf1f-e0358fb70577/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/e8514584-e329-486a-a787-9eba16afb63c/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/2607a783-9905-45f1-997f-9d3c014ca910/image.png)

Then, create a `deploy.yml` file inside the `.github/workflows` folder.

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/6162a208-8a21-469e-b792-2ef1e04f6e3a/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/1db8c263-f7f5-4759-a949-277f10af3861/image.png)
...
https://docs.github.com/en/enterprise-cloud@latest/actions/writing-workflows/workflow-syntax-for-github-actions#onworkflow_dispatchinputsinput_idtype
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/36c5eaca-e5bf-4a3f-9e5a-edabd119d151/image.png)

Okey, back to the main topic. With the configuration that we have made above, the inputs produced will be like this

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/83a5f9a0-3d0f-4862-96ac-8ff0814434fb/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/defb4f79-fcc6-4158-b822-df71613b040e/image.png)
...
https://docs.github.com/en/enterprise-cloud@latest/actions/writing-workflows/workflow-syntax-for-github-actions#permissions
...
https://docs.github.com/en/enterprise-cloud@latest/actions/writing-workflows/workflow-syntax-for-github-actions#choosing-github-hosted-runners.
...
2. Click _“Settings_” > _“Secrets and variables”_ > _“Actions”_
3. Click _“New repository secret”_
4. Fill in the name column with `CLOUDFLARE_API_TOKEN`
5. Fill in the _value_ column with the _API Token_ that we have created, then click _“Add secret”_
6. Repeat from step three with the name and _value_ for `CLOUDFLARE_ACCOUNT_ID`

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/255c65b8-78b6-4fd6-aaec-1f00b4b98aa2/image.png)
...
2. In the upper right corner, find and click “+ Add” then click “Pages”. Later, the “Workers & Pages” menu will appear
   in the sidebar menu on the left

   ![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/014db92b-1916-4560-9824-cfaaf9838728/image.png)
...
5. Then click “Create project”
   ...
   ![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/c1869328-8793-42ad-acd6-ee745f071b46/image.png)
...
Go to our repository page, click on “Actions” and you will see that there is a workflow running. You can click on it to
see the details, even the details of each job and step that is running.

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/b45850c9-6ef8-48ee-954f-8b6063a6c00e/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/94f39932-543d-4cef-8344-8e9f72edaa1f/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/c1b59b8c-fd45-40d4-88c5-a62b3f12bc17/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/8b58edf5-9cf5-4cf2-8275-389035b00bf5/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/affd997c-31b7-4263-a9e8-55184fc2946e/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/daea17e0-441d-4639-982b-d0767f4ae9ee/image.png)

Then, create a new tag in the “Choose a tag” field. We will create a `v1.0.0` tag as the initial version.

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/5eff2471-1e29-469f-b685-c867cdfd5d2b/image.png)

Then, click “Generate release notes”. This will automatically create release notes based on the commit history of the
successfully merged pull requests. For now, since there are no pull requests that have been merged, the release notes
appear empty.

Next, click “Publish release” and see there will be a workflow running!

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/c6aaa91c-6e30-474c-8007-b259cf6e87bb/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/e69d636e-b392-4974-bb66-a42d5640b56e/image.png)

Take a look at the `deploy` job on the “Deploy to Cloudflare Pages” step. We have successfully set the deployment based
on the tag from GitHub Releases, so the `--branch` argument should contain `production`.

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/82ee90b1-c242-4bc2-b3f2-58b9c469bcc7/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/c5c88843-8a4e-444b-8aa6-56ec5551b1c6/image.png)
...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/bf044884-8a79-4794-9661-3cb330e8b2eb/image.png)

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/1eea94e2-08e6-4f51-8720-0c2c690f5361/c87b13f3-2e9c-42a5-8e4f-d3b4b47272b7/image.png)

Then, check your “Workers & Pages” dashboard and our production environment is on the right track. Maybe, it feels like
there is no difference between production and preview for now. You can try to make changes to your project. In my

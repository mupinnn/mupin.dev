...
export default function PostDetailPage({ params }: PostDetailProps) {
  return (
    <div className="prose prose-slate prose-img:rounded dark:prose-invert">
      <p>We're on: {params.slug}</p>
      <p className="lead">
      ...
      <p>
        ...
        awful. Please hit <kbd>CTRL</kbd> button!
      </p>
      <p>
      ...
      <pre>
        <code className="language-html">
          ...
          &lt;/p&gt; &lt;p&gt; But a recent study shows that the celebrated appetizer may be linked
          to a series of rabies cases springing up around the country. &lt;/p&gt; &lt;!-- ... --&gt;
          &lt;/article&gt;
        </code>
      </pre>
      <p>
      ...
      <pre>
        <code className="language-js">console.log('awikwok')</code>
      </pre>
